...
const GruzinskieBludaSlide = () => {
    return (
        <div className="deliverySlider__item item-deliverySlider">
            <div className="item-deliverySlider__image">
                <Link to="/menu-dostavki/gruzinskie-bluda">
                    <svg id="" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 150 150" width="90" height="90">
                        <path
            ...
            <Link to="/menu-dostavki/gruzinskie-bluda">
                <h3 className="item-deliverySlider__title">Грузинские блюда</h3>
            </Link>
        </div>
    )
}

export default GruzinskieBludaSlide
